<template>
  <div>
    ...
    <div class="page-content">
        ...
        <div class="card-body">
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
            <div class="form-group">
              ...
              <input class="form-control" v-model="form.title" placeholder="e.g. 2026 MARCH - Fuel & Oil Withdrawal Log" />
            </div>
            <div class="form-group">
      ...
      <div class="card">
        <div class="card-header"><div class="card-title">Fuel &amp; Oil Entries</div></div>
...
const headers = [
  'CONTROL NO.', 'SEMESTER/QUARTER', 'TIME', 'DATE', 'DATE RELEASE', 'DATE WITHDRAW',
